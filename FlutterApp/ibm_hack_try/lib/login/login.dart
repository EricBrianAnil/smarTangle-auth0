...
import 'package:ibm_hack_try/data/database-helper.dart';
import 'package:ibm_hack_try/login/login_presenter.dart';
import 'package:ibm_hack_try/models/user.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Login Page",style: TextStyle(color: Colors.white),),
      ),
      key: scaffoldKey,
      body: new Container(
        child: new Center(
